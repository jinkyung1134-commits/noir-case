(function () {
  ...
  const dict = {
    ko: {
      ...
      cartClose: "장바구니 닫기",
      itemUnit: "개",
      heroSliderLabel: "메인 상품 전환",
      prevProduct: "이전 상품",
      nextProduct: "다음 상품",
      productDotLabel: "상품 보기",
      productSearch: "상품 검색",
      ...
      orderProducts: "주문 상품",
      total: "총 결제 금액",
      paymentSuccessEyebrow: "Payment Success",
      paymentSuccessTitle: "결제가 완료되었습니다",
      paymentSuccessCopy: "실제 서비스에서는 이 화면을 열기 전 서버에서 결제 승인과 주문 금액 검증을 처리해야 합니다.",
      paymentFailEyebrow: "Payment Failed",
      paymentFailTitle: "결제를 완료하지 못했습니다",
      paymentFailCopy: "카드 정보 또는 결제 설정을 확인한 뒤 다시 시도해 주세요.",
      retryOrder: "다시 주문하기",
    },
    en: {
      ...
      itemUnit: "item",
      heroSliderLabel: "Featured product carousel",
      prevProduct: "Previous product",
      nextProduct: "Next product",
      productDotLabel: "View product",
      ...
      paymentSuccessCopy: "Before this screen is shown in production, the server should approve the payment and verify the order amount.",
      paymentFailEyebrow: "Payment Failed",
      paymentFailTitle: "Payment was not completed",
      paymentFailCopy: "Check the card information or payment settings, then try again.",
    ...
    zh: {
      ...
      cartClose: "关闭购物车",
      itemUnit: "件",
      heroSliderLabel: "主推商品轮播",
      prevProduct: "上一个商品",
      nextProduct: "下一个商品",
      productDotLabel: "查看商品",
      productSearch: "搜索商品",
      allCategories: "全部分类",
      featured: "推荐",
      priceLow: "价格从低到高",
      ...
      orderProducts: "订单商品",
      total: "合计",
      paymentSuccessEyebrow: "支付成功",
      paymentSuccessTitle: "支付已完成",
      paymentSuccessCopy: "正式服务中，显示此页面前应由服务器完成支付批准和订单金额验证。",
      paymentFailEyebrow: "支付失败",
      paymentFailTitle: "支付未完成",
      paymentFailCopy: "请确认卡信息或支付设置后重试。",
      retryOrder: "重新下单",
    },
  };
